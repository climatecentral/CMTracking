...
rankedreleases.June2021 <- rankReleases(tracking.data.June2021.subsetted)
top10releases.June2021 <-rankedreleases.June2021[c(1:10),]
names(top10releases.June2021) <- c("Release", "Social", "Stories", "TV", "Total")
top5releases.June2021 <-rankedreleases.June2021[c(1:5),]
names(top5releases.June2021) <- c("Release", "Social", "Stories", "TV", "Total")
library(DT)
