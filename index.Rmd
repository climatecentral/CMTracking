...
```{r Ranked Releases, include = FALSE}
...
names(seasonsReleasesByHits) <- c("Date Published", "Release Name", "Social", "Stories", "TV", "Total Hits")
...
## Graphic Popularity by Type and Geo

```{r Graphic Popularity by Type and Geo, echo=FALSE}
...
par(mfrow=c(1,2))
pie(ggp.forpie$hitsPerGraphic,ggp.forpie$distribution, main="Geo Popularity")
pie(gtp.forpie$hitsPerGraphic, gtp.forpie$type, main = "Type Popularity")
```

## Without 'Warming Stripes' campaign

```{r Graphic Popularity by Type and Geo (without WS), echo=FALSE}
...
## Evergreen releases
```{r Evergreen releases, echo=FALSE}
