...
### Hits by Region
```{r June 2021 Hits by Region, eval=FALSE, warning=FALSE, message=FALSE}
...
### Hits by Region
```{r May 2021 Hits by Region, eval=FALSE, warning=FALSE, message=FALSE}
#compute hits by regions
