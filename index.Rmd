...
data <- read.csv('August2021TrackingData.csv')
...
expanded.hits.August2021 <- expanded.hits.draft.August2021[,c("source", "Twitter", "fb", "other",
...
CMN.August2021 <- expanded.hits.CMprograms.August2021[3,2:7]
CM.August2021 <- CMN.August2021 + expanded.hits.CMprograms.August2021[2,2:7]
CC.August2021 <- CM.August2021 + expanded.hits.CMprograms.August2021[1,2:7]
...
#change column names
names(aggregated.hits.CMprograms.August2021) <- c("Twitter", "Facebook", "Other ",
...
expanded.hits.July2021 <- expanded.hits.draft.July2021[,c("source", "Twitter", "fb", "other",
                                  "online.article", "radio", "tv")]
#restrict data to CC, CM, CMN sources
expanded.hits.CMprograms.July2021 <- subset(expanded.hits.July2021, source=="CC"|source=="CM"|source=="CMN")
#aggregate hits according to nest program model
CMN.July2021 <- expanded.hits.CMprograms.July2021[3,2:7]
CM.July2021 <- CMN.July2021 + expanded.hits.CMprograms.July2021[2,2:7]
CC.July2021 <- CM.July2021 + expanded.hits.CMprograms.July2021[1,2:7]
...
#change column names
names(aggregated.hits.CMprograms.July2021) <- c("Twitter", "Facebook", "Other ",
                          "Online Articles", "Radio", "TV")
library("formattable")
...
expanded.hits.June2021 <- expanded.hits.draft.June2021[,c("source", "Twitter", "fb", "other",
                                  "online.article", "radio", "tv")]
#restrict data to CC, CM, CMN sources
expanded.hits.CMprograms.June2021 <- subset(expanded.hits.June2021, source=="CC"|source=="CM"|source=="CMN")
#aggregate hits according to nest program model
CMN.June2021 <- expanded.hits.CMprograms.June2021[3,2:7]
CM.June2021 <- CMN.June2021 + expanded.hits.CMprograms.June2021[2,2:7]
CC.June2021 <- CM.June2021 + expanded.hits.CMprograms.June2021[1,2:7]
...
#change column names
names(aggregated.hits.CMprograms.June2021) <- c("Twitter", "Facebook", "Other ",
                          "Online Articles", "Radio", "TV")
library("formattable")
