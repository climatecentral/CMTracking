...
## Hit Type
library('openair')
YTDdata2021 <- dataReformatted[which(dataReformatted$month %in% c("March") & dataReformatted$year=="2021"),]
YTDdata2022 <- dataReformatted[which(dataReformatted$month %in% c("March") & dataReformatted$year=="2022"),]
...
theme(legend.title = element_blank())+
    geom_text(data=melted.tvgoalsandhits %>% filter(variable=="Airings" & Month=="February"), aes(label = 551), nudge_x = 0.4, nudge_y = 50, color="black") +
