...
theme(legend.title = element_blank())+
    geom_text(data=melted.tvgoalsandhits %>% filter(variable=="Airings" & Month=="October"), aes(label = 4670), nudge_x = 0.4, nudge_y = 50, color="black") +
...
labs(y="Articles", x="") +
theme(legend.title = element_blank()) +
    geom_text(data=melted.articlesgoalsandhits %>% filter(variable=="Articles" & Month=="October"), aes(label = 4073), nudge_x = 0.5, nudge_y = 50, color="black") +
    scale_x_discrete(limits = month.name)
  articlesgoalschart
