...
## Hit Type
library('openair')
YTDdata2020 <- dataReformatted[which(dataReformatted$month==c("January", "February") & dataReformatted$year=="2020"),]
YTDdata2021 <- dataReformatted[which(tracking.data$month==c("January", "February") & tracking.data$year=="2021"),]
