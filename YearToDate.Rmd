...
theme(legend.title = element_blank())+
    geom_text(data=melted.tvgoalsandhits %>% filter(variable=="Airings" & Month=="December"), aes(label = "3799"), nudge_x = 0.2, nudge_y = 200, color="black") +
...
labs(y="Articles", x="") +
theme(legend.title = element_blank()) +
    geom_text(data=melted.articlesgoalsandhits %>% filter(variable=="Articles" & Month=="December"), aes(label = value), nudge_x = 0.2, nudge_y = 200, color="black") +
    scale_x_discrete(limits = month.name)
  articlesgoalschart
```
