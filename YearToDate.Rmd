...
## Hit Type
library('openair')
YTDdata2021 <- dataReformatted[which(dataReformatted$month %in% c("June") & dataReformatted$year=="2021"),]
YTDdata2022 <- dataReformatted[which(dataReformatted$month %in% c("June") & dataReformatted$year=="2022"),]
