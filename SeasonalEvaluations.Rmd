...
Summer Evaluations are quarterly internal reports that look back on the releases published by meteorological season in order to gain insights into what the most popular topics were across our programs, across media platforms, which assets performed well and which content was less popular.
...
```{r Previous content used, echo = FALSE, warning=FALSE, message=FALSE}
